...
@Singleton
class AuthController @Inject() (cc: ControllerComponents)(implicit ec: ExecutionContext)
  ...
  private val redirectUri =
    sys.env.getOrElse("GOOGLE_REDIRECT_URI", "http://localhost:9000/authCallback")
